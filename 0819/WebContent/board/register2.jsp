      ...
      <div id="content">
        ...
        <div class="container-fluid">
		  ...
		  <div class="form-group">
		    ...
		    <input type="number" name="title" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
		    ...
		    <input type="text" name="writer" disabled="disabled" value=<%=id %> class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
		  </div>
