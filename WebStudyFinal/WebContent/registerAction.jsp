...
<%
	...
	if(result == 1){
		//검색 결과 user가 있을경우.
		out.print("<script>alert('이미 존재하는 아이디입니다.'); location.href ='/registerForm.jsp'</script>");
	}else if(result == 0){
		//검색결과 유저가 없을 경우
		...
		//예외처리
		out.print("<script>alert('데이터 오류입니다. 다시입력해주세요'); location.href ='/registerForm.jsp'</script>");
	}
