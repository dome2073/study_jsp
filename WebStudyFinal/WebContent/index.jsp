	...
	<div class="w3-top">
		<div class="w3-bar w3-red w3-card w3-left-align w3-large">
			...
			<a href="#"class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">개인정보수정</a>
				...
				<a href="/dice.jsp" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">주사위(회원만)</a> 
				<a href="/fortune.jsp"class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">오늘의 운세(누구나)</a> 
		</div>
	</div>
</body>
</html>